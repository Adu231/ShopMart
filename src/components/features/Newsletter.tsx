...
export default function Newsletter() {
  ...
  return (
    <section className="bg-gradient-to-r from-[#2874F0] to-blue-700 rounded shadow-sm p-6 md:p-8 text-white">
        ...
        {subscribed ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2 max-w-md mx-auto">
            <input
              ...
              required
            />
            <button type="submit" className="flex items-center justify-center gap-2 bg-[#FB641B] hover:bg-[#e55a18] px-5 py-2.5 rounded-lg font-semibold text-sm transition-all hover:scale-105 whitespace-nowrap">
