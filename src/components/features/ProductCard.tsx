      ...
      <div className="bg-card border border-border rounded hover:shadow-lg transition-all duration-300 group flex flex-col h-full overflow-hidden">
        ...
        <div className="p-3 flex flex-col flex-1">
          ...
          <div className="flex gap-2 mt-auto">
            ...
            <Link to={`/products/${product.id}`} onClick={e => e.stopPropagation()} className="flex-1 flex items-center justify-center gap-1 bg-[#FB641B] hover:bg-[#e55a18] text-white text-xs font-semibold py-2 rounded transition-colors">
              Buy Now
            </Link>
          </div>
        </div>
